  ...
  <body>
    ...
    <div class="container">
      ...
      <footer class="footer nohighlight">
        ...
        <p>Powered by <a href="https://github.com/telephone/LookingGlass">LookingGlass</a> and <a href="https://github.com/mojeda/ServerStatus">ServerStatus</a></p>
      </footer>
    ...
    <script src="assets/js/ServerStatus.min.js"></script>
  </body>
</html>