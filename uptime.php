...
<div class="progress-bar progress-bar-striped progress-bar-'.$memlevel.' active" style="width: '.$memory.';">'.$memory.'</div>
</div>';
...
<div class="progress-bar progress-bar-striped active progress-bar-'.$hddlevel.'" style="width: '.$hdd.';">'.$hdd.'</div>
</div>';
...
<div class="progress-bar progress-bar-success" style="width: 100%;"><small>Up</small></div>
</div>';
